...
//
//    public ResponseEntity updateAlarmDefinitions(List<String> alarmDefinitionRequest) {
...
//    }
//
//    private boolean updateAlarmDefinition(String alarmDefinitionDir, List<String> alarmDefinitionRequest) {
