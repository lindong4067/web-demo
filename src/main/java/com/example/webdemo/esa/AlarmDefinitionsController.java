...
//
//    private final AlarmServerUpdate fmRmiServerUpdate;
//
//    @Autowired
//    public AlarmDefinitionsController(AlarmServerUpdate fmRmiServerUpdate) {
//        this.fmRmiServerUpdate = fmRmiServerUpdate;
//    }
//
//    //    ***没有调试成功。
//    @PutMapping("/alarm/update")
//    @ResponseBody
//    public Object updateAlarmDefinition(@RequestBody List<String> alarmDefinitionsRequest){
